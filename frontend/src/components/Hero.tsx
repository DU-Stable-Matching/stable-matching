      ...
      <div id="home" className="w-full bg-transparent flex flex-col h-[50vh]">
        <div className="invisible md:visible flex justify-between items-center w-full px-8 py-4 md:py-10">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/signup" className="px-3 py-1 bg-transparent border-black border-2 text-black rounded-md">
            Sign Up
            </Link>
            <Link to="/login" className="px-3 py-1 bg-black border-white border-2 text-white rounded-md">
            Login
            </Link>
          </div>
        </div>
